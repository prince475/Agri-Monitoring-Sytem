const SideMenu = () => {
    return (
        <>
                 <div className="w-[306px] h-[1198px]">
  <div
    className="w-[306px] h-[1198px] absolute left-[-0.5px] top-[-0.5px] bg-white"
    style={{ boxShadow: "0px 10px 60px 0 rgba(226,236,249,0.5)" }}
  />
  <div className="w-[250px] h-[46px] absolute left-[27.5px] top-[255.5px] rounded-lg bg-[#5932ea]" />
  <div className="w-[116px] h-6">
    <svg
      width={24}
      height={24}
      viewBox="0 0 24 24"
      ...
      className="w-6 h-6 absolute left-[39px] top-[139px]"
    ...
    <p className="absolute left-[77px] top-[140px] text-sm font-medium text-left text-[#9197b3]">
      Dashboard
    </p>
  </div>
  <div className="w-[231px] h-6">
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 absolute left-[39px] top-[203px]"
      preserveAspectRatio="none"
    >
      <path
    ...
    <p className="absolute left-[77px] top-[205px] text-sm font-medium text-left text-[#9197b3]">
      Product
    </p>
    <svg
      width={16}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-4 h-4 absolute left-[254px] top-[207px]"
  ...
  <div className="w-[231px] h-6">
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 absolute left-[39px] top-[267px]"
      preserveAspectRatio="none"
    >
      <path
    ...
    <p className="absolute left-[77px] top-[269px] text-sm font-medium text-left text-white">
      Customers
    </p>
    <svg
      width={16}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-4 h-4 absolute left-[254px] top-[271px]"
      preserveAspectRatio="xMidYMid meet"
    >
      <path
        d="M6 12L10 8L6 4"
  ...
  <div className="w-[231px] h-6">
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 absolute left-[39px] top-[331px]"
      preserveAspectRatio="none"
    >
      <path
    ...
    <p className="absolute left-[77px] top-[333px] text-sm font-medium text-left text-[#9197b3]">
      Income
    </p>
    <svg
      width={16}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-4 h-4 absolute left-[254px] top-[335px]"
      preserveAspectRatio="xMidYMid meet"
    >
      <path
        d="M6 12L10 8L6 4"
  ...
  <div className="w-[231px] h-6">
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 absolute left-[39px] top-[395px]"
      preserveAspectRatio="none"
    >
      <path
    ...
    <p className="absolute left-[77px] top-[397px] text-sm font-medium text-left text-[#9197b3]">
      Promote
    </p>
    <svg
      width={16}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-4 h-4 absolute left-[254px] top-[399px]"
      preserveAspectRatio="xMidYMid meet"
    >
      <path
        d="M6 12L10 8L6 4"
  ...
  <div className="w-[231px] h-6">
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-6 h-6 absolute left-[39px] top-[459px]"
      preserveAspectRatio="none"
    >
      <path
    ...
    <p className="absolute left-[77px] top-[461px] text-sm font-medium text-left text-[#9197b3]">
      Help
    </p>
    <svg
      width={16}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-4 h-4 absolute left-[254px] top-[463px]"
      preserveAspectRatio="xMidYMid meet"
    >
      <path
        d="M6 12L10 8L6 4"
  ...
  <img className="absolute left-[27.5px] top-[1079.5px]" src="ellipse-8.png" />
  <div className="w-[101px] h-[38px]">
    <p className="absolute left-[82px] top-[1082px] text-sm font-medium text-left text-black">
      Evano
    </p>
    <p className="absolute left-[82px] top-[1102px] text-xs text-left text-[#757575]">
      Project Manager
    </p>
  </div>
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="w-6 h-6 absolute left-[254px] top-[1089px]"
    preserveAspectRatio="none"
  >
    <path
      d="M6 9L12 15L18 9"
  ...
  <div className="w-[250px] h-[150px]">
    <div
      className="w-[250px] h-[150px] absolute left-[27.5px] top-[883.5px] rounded-[20px]"
      style={{ background: "linear-gradient(164.02deg, #eaabf0 -35.2%, #4623e9 126.45%)" }}
    />
    <p className="w-[183px] absolute left-[62px] top-[910px] text-sm font-semibold text-center text-white">
      Upgrade to PRO to get access all Features!
    </p>
    <div className="w-[203px] h-10">
      <div
        className="w-[203px] h-10 absolute left-[51.5px] top-[971.5px] rounded-[20px] bg-white"
        style={{ boxShadow: "2px 4px 4px 0 rgba(79,42,234,0.17)" }}
      />
      <p className="absolute left-[107px] top-[982px] text-sm font-semibold text-center text-[#4925e9]">
        Get Pro Now!
      </p>
    </div>
  </div>
  <div className="w-[195px] h-[39px]">
    <p className="absolute left-[73px] top-9 text-[26px] font-semibold text-left text-black">
      Dashboard
    </p>
    <svg
      width={37}
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-[37px] h-[37px] absolute left-7 top-[37px]"
      preserveAspectRatio="none"
    >
      <path
  ...
  <p className="absolute left-[227px] top-[54px] text-[10px] font-medium text-left text-[#838383]">
    v.01
  </p>
</div>;
        </>
